...
export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto py-12 px-4">
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>
          Please give at least 24 hours' notice if you need to cancel or change
          your appointment.
        </li>
        <li>
          Late cancellations (under 24 hours) or missed appointments may result
          in a charge.
        </li>
      </ul>
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>
          ...
          happy. If there is an issue, please let us know within 48 hours so we
          can make it right.
        </li>
      </ul>
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>
          We reserve the right to update prices, services, or these terms at any
          time. The latest version will always be available on the website.
        </li>
      </ul>
